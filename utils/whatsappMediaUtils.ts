...
import { fetchWithTimeout, handleFetchErrors } from '@/utils/whatsappUtils';
...
export async function downloadAndSendMedia(mediaId: string, mimeType: string): Promise<{ buffer: Buffer; filename: string }> {
  try {
