...
interface OldImagingResultsPageProps {
  oldResults: ImagingResult[];
  error?: string;
}
...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  try {
    ...
    return {
      props: {
        error: 'Failed to fetch older imaging results',
        oldResults: []
      }
    };
  }
...
// Dashboard component
const OldImagingResultsDashboard: React.FC<{ oldResults: ImagingResult[] }> = ({ oldResults }) => {
  return (
...
// Page component
const OldImagingResultsPage: React.FC<OldImagingResultsPageProps> = ({ oldResults, error }) => {
  if (error) {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <OldImagingResultsDashboard oldResults={oldResults} />
    </div>
  );
};

export default OldImagingResultsPage;