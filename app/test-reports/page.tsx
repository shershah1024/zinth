...
import { TestElement, MedicalTestsDashboardProps, MedicalTestsDashboardState } from '@/types/types';

const MedicalTestsDashboard: React.FC<MedicalTestsDashboardProps> = ({ initialTestElements }) => {
  const [state, setState] = useState<MedicalTestsDashboardState>({
    testElements: initialTestElements || [
      {
        ...
        history: [
          ...
          { date: '2023-04-15', value: 7.3 },
          { date: '2023-07-15', value: 7.5 },
        ]
      },
      {
        id: 2,
        ...
        history: [
          { date: '2022-10-15', value: 13.5 },
          { date: '2023-01-15', value: 13.8 },
          { date: '2023-04-15', value: 14.0 },
          { date: '2023-07-15', value: 14.2 },
        ]
      },
      {
        id: 3,
        ...
        normalRange: '<200',
        history: [
          { date: '2022-09-30', value: 210 },
          { date: '2022-12-30', value: 195 },
          { date: '2023-03-30', value: 188 },
          { date: '2023-06-30', value: 180 },
        ]
      },
    ],
  ...
  const handleElementClick = (element: TestElement) => {
